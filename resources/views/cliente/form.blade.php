...
<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::date('Fecha_de_nacimiento', $cliente->Fecha_de_nacimiento, ['class' => 'form-control' . ($errors->has('Fecha de nacimiento') ? ' is-invalid' : ''), 'placeholder' => 'Fecha De Nacimiento']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::text('Categoria', $cliente->Categoria, ['class' => 'form-control' . ($errors->has('Categoria') ? ' is-invalid' : ''), 'placeholder' => 'Categoria']) }}
